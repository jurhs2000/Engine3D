...
rend.glLine(V2(100,100), V2(500, 100), newColor(1,0,0))
# Horizontal, right to left
rend.glLine(V2(500,110), V2(100, 110), newColor(0,1,0))
# Vertical, top to bottom
rend.glLine(V2(305,400), V2(305, 120), newColor(1,0,0))
# Vertical, bottom to top
rend.glLine(V2(295,120), V2(295, 400), newColor(0,1,0))
# Diagonal, top left to bottom right
rend.glLine(V2(-1,1), V2(1,-1), newColor(1,0,0), True)
# Diagonal, bottom left to top right
rend.glLine(V2(-1,-1), V2(1,1), newColor(0,1,0), True)
...
for x in range(width - 1):
  ...
  rend.glLine(V2(x,y0), V2((x+1),y1), newColor(0.5, 0, 0.5))

# Diagonal, bottom right to top left
rend.glLine(V2(1,-1), V2(-1,1), newColor(0.5,0.5,0), True)
# Diagonal, top right to bottom left
rend.glLine(V2(1,1), V2(-1,-1), newColor(0,0.5,0.5), True)
...
for x in range(21):
  # left to right
  rend.glLine(V2(((x/10)-1), -1), V2(1, ((x/10)-1)), newColor(0.4, 0.5, 0.3), True)
  # top to bottom
  rend.glLine(V2(-1, ((x/10)-1)*-1), V2(((x/10)-1), -1), newColor(0.4, 0.5, 0.3), True)
  # bottom to top
  rend.glLine(V2(-1, ((x/10)-1)), V2(((x/10)-1), 1), newColor(0.4, 0.5, 0.3), True)
  # left to right
  rend.glLine(V2(((x/10)-1), 1), V2(1, ((x/10)-1)*-1), newColor(0.4, 0.5, 0.3), True)
...
for x in range(21):
  # right to left
  rend.glLine(V2(1, ((x/10)-1)), V2(((x/10)-1), -1), newColor(0.8, 0.1, 0.3), True)
  # bottom to top
  rend.glLine(V2(((x/10)-1), -1), V2(-1, ((x/10)-1)*-1),  newColor(0.8, 0.1, 0.3), True)
  # top to bottom
  rend.glLine(V2(((x/10)-1), 1), V2(-1, ((x/10)-1)), newColor(0.8, 0.1, 0.3), True)
  # right to left
  rend.glLine(V2(1, ((x/10)-1)*-1), V2(((x/10)-1), 1), newColor(0.8, 0.1, 0.3), True)
...
for x in range(200):
  ...
  rend.glLine(V2(x+400,y0), V2((x+400+1),y1), newColor(0.9, 0.3, 0.1))

for x in range(400):
  y0 = int(pow(((x-200)/20), 3))
  y1 = int(pow((((x-200)+1)/20), 3))
  rend.glLine(V2(x+100,y0+300), V2((x+100+1),y1+300), newColor(0.9, 0.3, 0.1))
